...
<figcaption>Incoming Requests</figcaption>
...
<figcaption>Load across all the entire MariaDB cluster</figcaption>
...
<figcaption>CPU load on the Rancher Agent with Ejabberd</figcaption>
...
<figcaption>Our newly added server. rancher-agent-<b>CV19</b> reporting for duty!</figcaption>
...
<figcaption>Even with a 64 core node, the server is heading towards certain failure!</figcaption>
...
<figcaption>I would like to ski down that slope!</figcaption>
