...
<figcaption>Browse to the path of the private key you generated from PuttyGen</figcaption>
...
<figcaption>Vagrant runs by default on your local host on port 2222 under Windows</figcaption>
...
<figcaption>Behold the beauty of ASCII art</figcaption>
